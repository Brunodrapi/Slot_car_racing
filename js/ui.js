...
const I18N = {
  fr: {
    ...
    howto: 'Pouce droit (ou n’importe quelle touche / clic) : accélérer, relâcher pour freiner. Pouce gauche (ou flèches / molette) : choisir la trajectoire — intérieure, idéale ou extérieure. Trop vite dans un virage, c’est le bac à gravier.',
  ...
  en: {
    ...
    howto: 'Right thumb (or any key / click): accelerate, release to brake. Left thumb (or arrows / wheel): pick the line — inside, racing or outside. Too fast into a corner and it’s the gravel.',
