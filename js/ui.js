...
const I18N = {
  fr: {
    ...
    newRecord: 'Nouveau record !', yourBest: 'Ton record', name: 'Nom du pilote', sound: 'Son', language: 'Langue', showLines: 'Afficher les trajectoires', resetAll: 'Effacer la progression', resetConfirm: 'Effacer toute la progression ?',
  ...
  en: {
    ...
    newRecord: 'New record!', yourBest: 'Your best', name: 'Driver name', sound: 'Sound', language: 'Language', showLines: 'Show driving lines', resetAll: 'Erase progress', resetConfirm: 'Erase all progress?',
