...
const I18N = {
  fr: {
    ...
    lap: 'Tour', last: 'Dernier', best: 'Meilleur', grip: 'adhérence', gas: 'GAZ', brake: 'FREIN', holdToGo: 'Maintiens une touche pour accélérer', holdToGoTouch: 'Maintiens l’écran pour accélérer', lineHintKeys: 'Flèches / molette : trajectoire', lineHintTouch: 'Pouce gauche : trajectoire',
  ...
  en: {
    ...
    lap: 'Lap', last: 'Last', best: 'Best', grip: 'grip', gas: 'GAS', brake: 'BRAKE', holdToGo: 'Hold a key to accelerate', holdToGoTouch: 'Hold anywhere to accelerate', lineHintKeys: 'Arrows / wheel: line', lineHintTouch: 'Left thumb: line',
