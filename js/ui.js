...
const I18N = {
  fr: {
    ...
    howto: 'Cadran du bas (ou n’importe quelle touche / clic) : accélérer, relâcher pour freiner. Pouce gauche (ou flèches / molette) : choisir la trajectoire — intérieure, idéale ou extérieure. Trop vite dans un virage, c’est le bac à gravier.',
    ...
    lap: 'Tour', last: 'Dernier', best: 'Meilleur', grip: 'adhérence', gas: 'GAZ', brake: 'FREIN', holdToGo: 'Maintiens une touche pour accélérer', holdToGoTouch: 'Maintiens le cadran pour accélérer', lineHintKeys: 'Flèches / molette : trajectoire', lineHintTouch: 'Pouce gauche : trajectoire',
    ...
    newRecord: 'Nouveau record !', yourBest: 'Ton record', name: 'Nom du pilote', sound: 'Son', language: 'Langue', showLines: 'Guide de freinage', telemetry: 'Télémétrie (touche G)', camera: 'Caméra', camFollow: 'Orientée piste', camFixed: 'Fixe', resetAll: 'Effacer la progression', resetConfirm: 'Effacer toute la progression ?',
  ...
  en: {
    ...
    howto: 'Bottom dial (or any key / click): accelerate, release to brake. Left thumb (or arrows / wheel): pick the line — inside, racing or outside. Too fast into a corner and it’s the gravel.',
    ...
    lap: 'Lap', last: 'Last', best: 'Best', grip: 'grip', gas: 'GAS', brake: 'BRAKE', holdToGo: 'Hold a key to accelerate', holdToGoTouch: 'Hold the dial to accelerate', lineHintKeys: 'Arrows / wheel: line', lineHintTouch: 'Left thumb: line',
    ...
    newRecord: 'New record!', yourBest: 'Your best', name: 'Driver name', sound: 'Sound', language: 'Language', showLines: 'Braking guide', telemetry: 'Telemetry (G key)', camera: 'Camera', camFollow: 'Track-aligned', camFixed: 'Fixed', resetAll: 'Erase progress', resetConfirm: 'Erase all progress?',
...
class UI {
  ...
  _onChange(e) {
    ...
    if (el.id === 'sel-cam') { s.camRotate = el.value === '1'; storeSave(s); this.app.renderer.rotate = s.camRotate; }
