...
const PROP_KINDS = [
  { id: 'oak', src: 'sprites/env/p01.png', wm: 12.3, anchor: [0.564, 1.0], weight: 3, near: 10, far: 28 },
  { id: 'oak2', src: 'sprites/env/p02.png', wm: 12.4, anchor: [0.72, 0.975], weight: 2, near: 10, far: 28 },
  { id: 'tree', src: 'sprites/env/p05.png', wm: 9.2, anchor: [0.58, 0.956], weight: 4, near: 9, far: 26 },
  { id: 'tree2', src: 'sprites/env/p19.png', wm: 6.2, anchor: [0.66, 0.949], weight: 6, near: 9, far: 26 },
  { id: 'tree3', src: 'sprites/env/p21.png', wm: 5.5, anchor: [0.514, 0.947], weight: 5, near: 9, far: 26 },
  { id: 'tree4', src: 'sprites/env/p25.png', wm: 7.8, anchor: [0.74, 1.0], weight: 4, near: 9, far: 26 },
  { id: 'tree5', src: 'sprites/env/p28.png', wm: 9.3, anchor: [0.627, 0.94], weight: 4, near: 9, far: 26 },
  { id: 'bush', src: 'sprites/env/p13.png', wm: 5.1, anchor: [0.66, 0.875], weight: 3, near: 9, far: 20 },
  { id: 'bush2', src: 'sprites/env/p15.png', wm: 4.3, anchor: [0.46, 1.0], weight: 3, near: 9, far: 20 },
  { id: 'house', src: 'sprites/env/p03.png', wm: 11.2, anchor: [0.539, 0.947], weight: 1, near: 14, far: 26 },
  { id: 'house2', src: 'sprites/env/p04.png', wm: 11.3, anchor: [0.644, 0.946], weight: 1, near: 14, far: 26 },
  { id: 'house3', src: 'sprites/env/p10.png', wm: 9.9, anchor: [0.526, 0.905], weight: 1, near: 14, far: 26 },
  { id: 'house4', src: 'sprites/env/p11.png', wm: 13.5, anchor: [0.462, 0.978], weight: 1, near: 15, far: 26 },
  { id: 'house5', src: 'sprites/env/p27.png', wm: 12.2, anchor: [0.612, 0.96], weight: 1, near: 15, far: 26 },
  { id: 'house6', src: 'sprites/env/p35.png', wm: 10.9, anchor: [0.557, 0.898], weight: 1, near: 14, far: 26 },
  { id: 'barn', src: 'sprites/env/p08.png', wm: 14.1, anchor: [0.44, 0.929], weight: 1, near: 16, far: 27 },
  { id: 'ruin', src: 'sprites/env/p18.png', wm: 8.3, anchor: [0.579, 0.965], weight: 1, near: 12, far: 24 },
  { id: 'fence', src: 'sprites/env/p30.png', wm: 10.4, anchor: [0.72, 0.947], weight: 3, near: 9, far: 13 },
  { id: 'fence2', src: 'sprites/env/p36.png', wm: 9.9, anchor: [0.78, 0.938], weight: 3, near: 9, far: 13 },
  { id: 'well', src: 'sprites/env/p33.png', wm: 7.6, anchor: [0.566, 0.947], weight: 1, near: 11, far: 20 },
  { id: 'planter', src: 'sprites/env/p37.png', wm: 7.5, anchor: [0.679, 0.871], weight: 2, near: 9, far: 16 },
  { id: 'barrel', src: 'sprites/env/p38.png', wm: 6.6, anchor: [0.7, 0.918], weight: 2, near: 9, far: 16 },
  { id: 'crate', src: 'sprites/env/p29.png', wm: 4.6, anchor: [0.586, 0.891], weight: 2, near: 9, far: 16 },
  { id: 'pillar', src: 'sprites/env/p40.png', wm: 4.5, anchor: [0.5, 0.97], weight: 1, near: 10, far: 20 },
  { id: 'rock', src: 'sprites/env/p31.png', wm: 4.5, anchor: [0.665, 0.886], weight: 2, near: 9, far: 20 },
];
